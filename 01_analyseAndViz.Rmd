...
save_html(
  tags$html(
    ...
    tags$body(    
      h2("Les communes et quartiers populos au centre de Genève, avec des larges différences en ville"),
      ...
      h3("Quels sont les quartiers huppés/populaires?"),
