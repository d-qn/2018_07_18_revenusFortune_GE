    ...
    tags$body(    
      ...
      div(class = "descr", HTML(
        str_c("Revenu annuel brut médian vs fortune nette médiane des contribuables mariés selon la commune en 2014",
              '&nbsp;<img src="https://www.tdg.ch/extern/interactive_wch/tdg/assets/hand_interactive.png" width="14" align="top">  La taille des cercles est proportionnelle aux effectifs (nombres de contribuables mariés). La ligne représente la tendance linéaire entre revenu et fortune.'))),
      div(class="container", 
          hcb
      ),
      div(id = "cite", HTML(footer))
